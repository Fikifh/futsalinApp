package com.example.dwexid.futsalin.activity;
...
import com.example.dwexid.futsalin.adapter.GorAdapter;
...
public class main_futsalin extends AppCompatActivity
    ...
    private ArrayList<GorModel> gorModelArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GorAdapter(gorModelArrayList);
    ...
    void addData(){
        gorModelArrayList = new ArrayList<>();
        gorModelArrayList.add(new GorModel("GOR Mayasari", "Bandung"));
        gorModelArrayList.add(new GorModel("GOR BHO ", "Bandung"));
        gorModelArrayList.add(new GorModel("GOR Citra", "Bandung"));
        gorModelArrayList.add(new GorModel("GOR Progresif", "Bandung"));
    }
}
